...
function initWeb3() {
  ...
  showWarning('You need <a href="https://metamask.io/">Metamask</a> installed and connected to the voxnet network');
}
...
function initContract() {
  ...
  $.getJSON('Roulette.json', (data) => {
    web3.version.getNetwork((err, netId) => {
      ...
      switch (netId) {
        case "1": // main network
          showWarning("You're on the Ethereum main network. Please switch to Voxnet.");
          break
        case "2": // morden
          showWarning("You're on the Morden test network. Please switch to Voxnet.");
          break
        case "3": // ropsten
          showWarning("You're on the Ropsten test network. Please switch to Voxnet.");
          break
        case "4": // rinkeby
          showWarning("You're on the Rinkeby test network. Please switch to Voxnet.");
          break
        case "42": // kovan
          showWarning("You're on the Kovan test network. Please switch to Voxnet.");
          break
        case "827487": //voxnet
          address = '0xc64b8f2349552d5467d64835259bc240dfb17fea';
          break
